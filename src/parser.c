...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [26] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(50),
  ...
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_rules_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_rules_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_rules_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_rules_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_rule, 2, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_common_rules_repeat1, 2, 0, 0),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_common_rules_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [80] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_common_rules_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [83] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_common_rules_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_rule, 3, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dependencies_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dependencies_repeat1, 2, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directives, 1, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_recipe, 3, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_directive, 2, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_common_rules, 2, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_rules, 2, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_common_rules, 3, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_common_rule, 3, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_common_rule, 2, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_rules, 3, 0, 0),
  ...
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dependency, 3, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_contents, 1, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [133] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_contents_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_contents_repeat1, 2, 0, 0),
  [138] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_contents_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_contents_repeat1, 3, 0, 0),
